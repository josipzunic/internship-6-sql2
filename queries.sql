...
LEFT JOIN match_teams mh ON mh.match_id = m.match_id AND mh.role = 'home'
LEFT JOIN teams th ON th.team_id = mh.team_id
LEFT JOIN match_teams mg ON mg.match_id = m.match_id AND mg.role = 'guest'
